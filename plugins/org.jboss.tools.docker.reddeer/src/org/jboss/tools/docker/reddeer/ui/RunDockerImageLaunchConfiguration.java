...
public class RunDockerImageLaunchConfiguration extends LaunchConfiguration {
	...
	// needed for correct selection.
	private LabeledText getContainerNameTextWidget() {
		final PushButton button = new PushButton("Search...");
		return Display.syncExec(new ResultRunnable<LabeledText>() {

			@Override
			public LabeledText run() {
				return new LabeledText(new ReferencedComposite() {
	...
	// ports tab
	public void setPublishallexposedportstorandomportsonthehostinterfaces(boolean checked) {
	...
	public void addPort(String containerPort, String hostAddress, String hostPort) {
		...
		setPublishallexposedportstorandomportsonthehostinterfaces(false);
		new PushButton("Add...").click();
